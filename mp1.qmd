...
In 2022, North Carolina State University Bus had the lowest expenses per UPT of $1.18. 
```{r echo=FALSE, warning=FALSE, message=FALSE}
#agency and mode (large transit systems only)
...
In 2022, ferryboat managed by Cape May Lewes Ferry garnered the highest total fares per UPT of $9.23.
```{r echo=FALSE, warning=FALSE, message=FALSE}
#agency and mode (large transit systems only)
...
In 2022, Vanpool managed by Metropolitan Transportation Commission achieved the lowest expenses per VRM of $0.44.
```{r echo=FALSE, warning=FALSE, message=FALSE}
#agency and mode (large transit systems only)
